...
<head>
	...
	<title>{=$base_title=}｜排水管・給水管の内視鏡調査なら　株式会社三央</title>
	...
	<div id="wrapper">
		...
		<main id="main" class="main-under">
			...
			<div id="mainvisual" class="under-visual" style="background-image: url('../images/ud-visual-img01.jpg');">
				<div class="container">
					<h2>
						<span class="h2-jp">【{=$base_title=}】</span>
			...
			<div id="content">
				...
				<div class="section sech3">
					<div class="sec-wrapper">
						<div class="under-bx">
							<h3 class="h3">排水管・給水管調査レポート</h3>
							<p>
								排水管・給水管の材質や形状、設置の状況などは、建物によってまったく異なります。また使用条件も同じではありません。そのため配管調査の方法や結果も多岐にわたります。
							</p>
							<p>
								こちらでは、東京23区・関東をはじめ全国において数多くの排水管・給水管調査を行う株式会社三央における調査レポート一覧にしてご紹介します。くわしい内容については、詳細ページにてご覧ください。
							</p>
						</div>
					</div>
				</div>
				...
				<div class="section">
					<div class="overnote">
						<div class="ovn-tab">
							<ul class="ovn-head">
								<li class="active" data-tab-group="tab1" data-tab="tb1">All</li>
								<li data-tab-group="tab1" data-tab="tb2">ニュース</li>
								<li data-tab-group="tab1" data-tab="tb3">コラム</li>
								<li data-tab-group="tab1" data-tab="tb4">更新情報</li>
							</ul>
							<?php $limitNum = 10 ?>
							<div class="ovn-inner">
								<div class="ovn-box active" data-tab-group="tab1" data-tab-content="tb1">
								...
								<div class="ovn-box" data-tab-group="tab1" data-tab-content="tb2">
									<ONContributeSearch page="@$_GET['p']" limit="$limitNum" category="1">
										<div class="ovn-bx">
											<ONContributeFetch>
												<div class="ovn-item">
													<?php
								...
								<div class="ovn-box" data-tab-group="tab1" data-tab-content="tb3">
									<ONContributeSearch page="@$_GET['p']" limit="$limitNum" category="2">
										<div class="ovn-bx">
											<ONContributeFetch>
												<div class="ovn-item">
													<?php
								...
								<div class="ovn-box" data-tab-group="tab1" data-tab-content="tb4">
									<ONContributeSearch page="@$_GET['p']" limit="$limitNum" category="3">
										<div class="ovn-bx">
											<ONContributeFetch>
												<div class="ovn-item">
													<?php
