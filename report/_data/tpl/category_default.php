...
<head>
	...
	<title><?php echo $current_category_name; ?>|<?php echo $base_title; ?>｜排水管・給水管の内視鏡調査なら　株式会社三央</title>
	...
	<div id="wrapper">
		...
		<main id="main" class="main-under">
			...
			<div id="mainvisual" class="under-visual" style="background-image: url('../../images/ud-visual-img01.jpg');">
				<div class="container">
					<h2>
						<span class="h2-jp"><?php echo $current_category_name; ?></span>
...
?>
												<div class="ovn-item">
													...
													<p class="ovn-tt">
														<a href="../<?php echo $url; ?>">
															<?php echo mb_strimwidth($title, 0, 0, '…', 'UTF-8'); ?>
														</a>
													</p>
												</div>
											<?php
